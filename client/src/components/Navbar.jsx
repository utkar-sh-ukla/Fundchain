...
const Navbar = () => {
    ...
    return (
        <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
            <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#f0f0f0] dark:bg-[#1c1c24] rounded-[100px]">
                <input type="text" placeholder="Search for campaigns"
                       className="flex w-full font-epilogue font-normal text-[14px] placeholder:text-[#4b5264] text-[#1c1c24] dark:text-white bg-transparent border-none outline-none"/>
            ...
            <div className="sm:flex hidden flex-row justify-end gap-4">
                ...
                <Link to="/profile">
                    <div
                        className="w-[52px] h-[52px] rounded-full bg-[#f0f0f0] dark:bg-[#2c2f32] flex justify-center items-center cursor-pointer">
